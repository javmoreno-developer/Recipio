...
export class FirebaseWebService extends FirebaseService implements OnDestroy {
  ...
  async init() {
    const firebaseConfig = {
      apiKey: "AIzaSyDViLCerrHvh60QiFh344xOOFnRwZTWN-k",
      authDomain: "recipio-a8c1b.firebaseapp.com",
      projectId: "recipio-a8c1b",
      storageBucket: "recipio-a8c1b.appspot.com",
      messagingSenderId: "1004299718913",
      appId: "1:1004299718913:web:3bcb3a63c2018f0f254b00",
      measurementId: "G-PCBSBRZYRT"
    };
  ...
  public subscribeToCollectionWithQueryUser(collectionName, subject: BehaviorSubject<any[]>, mapFunction: (el: DocumentData) => any, condition: string): Unsubscribe {
    return onSnapshot(query(collection(this.db, collectionName),where("uidUsu","==",condition)), (snapshot) => {
      subject.next(snapshot.docs.map<any>(doc => mapFunction(doc)));
    }, error => { });
  }
